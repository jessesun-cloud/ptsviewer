...
bool 
ImpVertexBufferRenderBase::IsVboAvailable()
{
  return gglVBOAvailable;
}

void 
ImpVertexBufferRenderBase::Init()
{
...
ImpVertexBufferRenderBase::ImpVertexBufferRenderBase()
{
  Init();
  mPointCount = 0;
  mbInit = false;
...
void 
ImpVertexBufferRenderBase::DrawPoints(int start, int npt,
...
ImpVertexBufferRenderBase::Create(bool bUseVbo)
{
  Init();
  if (bUseVbo && IsVboAvailable())
  {
    return new ImpVertexBufferVboRender();
  }
  else
  {
    return new ImpVertexBufferRender();
  }
}

/////////////////////////////////////////////////
void 
ImpVertexBufferRender::AddPoints(int npt, float* pPointWidth,
...
void 
ImpVertexBufferRender::DrawPoints(int start, int npt, bool bVariableColor)
{
  try
  {
...
ImpVertexBufferVboRender::ImpVertexBufferVboRender()
{
  mbDouble = 0;
  mbHasColor = false;
  mbHasNormal = false;
...
void 
ImpVertexBufferVboRender::DrawPoints(int start, int npt, bool bVariableColor)
{
  try
  {
    if (npt == -1)
...
void 
ImpVertexBufferVboRender::AddPoints(int npt, float* pPointWidth,
     unsigned char *pRgbaColor, float *pPoints, float *pNormals)
{
  mbInit = true;
  mbDouble = false;
...
unsigned char *pRgbaColor, double *pPoints, float *pNormals)
{
 ...
 void ImpVertexBufferVboRender::AddRgbPoints(int npt, float* pPointWidth,
